    ...
    <x-crud.form :title="$title" :action="$action" :method="$method" :backRoute="route('admin.tariffs.index')">
        <x-crud.fields>
            ...
            <x-form.row cols="3">
                ...
                <x-form.input name="wait_per_min" type="number" step="0.01" min="0" label="₽ за минуту ожидания"
            ...
            <x-ui.card class="mt-4">
                <div class="text-sm font-medium mb-2">
                    Фиксированный тариф (для сложных тарифов)
                </div>
                ...
                <x-ui.alert tone="muted" class="mt-2">
                    Используется для фиксированных тарифов (например: «Газель 5 метров Тент»).
                    Для поминутных тарифов эти поля можно не заполнять.
                </x-ui.alert>
            </x-ui.card>
